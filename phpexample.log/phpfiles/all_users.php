...
<body>
  ...
  <br><h2 align="center">Все пользователи</h2>
  <table border="1" style="margin: 0 auto;" width="50%">
    ...
    <?php
      ...
      for ($i = 0; $i < count($users); $i++ ) {
        echo "<tr>";
        echo "<td><b>".$users[$i]["name"]."</b></td>";
        echo "<td>";
        echo "<a href='send_mess.php?to=".$users[$i]["id"]."' title='Отправить сообщение'>Написать сообщение</a>";
      } 
    ?>
  </table>
  <?php endif; ?>
